...
- Use `.learnings/` for raw learnings, corrections, errors, and feature requests before promoting anything broader
- **Do not auto-promote** `.learnings/` content into `SOUL.md`, `AGENTS.md`, `TOOLS.md`, or `MEMORY.md` without explicit human review or very high confidence that it is broadly useful and safe
- **Text > Brain** 📝
